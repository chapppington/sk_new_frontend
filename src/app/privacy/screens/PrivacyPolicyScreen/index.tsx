    ...
    <main className="max-w-[1000px] mx-auto">
      <section className="py-16 mt-24">
        <CustomContainer>
          ...
          <p className="text-white/80 mb-6">(Далее по тексту – Политика)</p>
          ...
          <div className="space-y-6 text-white/80">
            ...
            <p>
              ...
              Обществом с ограниченной ответственностью "СибКомплект" (далее –
              Оператор).
            </p>
            ...
            <p>
              ...
              и гражданина при обработке его персональных данных, предотвращение
              нарушений законных прав и интересов Пользователей, защиту
              персональных данных Пользователей от несанкционированного доступа
              и разглашения, недопущение нанесения возможного ущерба, вызванного
              неправомерными умышленными или неосторожными действиями
              юридических и (или) физических лиц путем безвозмездного присвоения
              информации или ее разглашения, нарушением установленных норм,
            ...
            <p>
              ...
              веб-сайта https://sibkomplekt.ru. Веб-сайт не контролирует и не
              несет ответственности за сайты третьих лиц, на которые
              Пользователь может перейти по ссылкам, доступным на Веб-сайте
              https://sibkomplekt.ru.
            </p>

            <p>
              1.4. Действующая редакция Политики обработки персональных данных
              размещена также в сети Интернет по адресу https://sibkomplekt.ru и
              является публичной офертой ООО «СибКомплект»
            </p>

            <p>
              1.5. Акцепт оферты осуществляется путем выбора чек-бокса «согласен
              с пользовательским соглашением и политикой обработки персональных
              данных», что является принятием (акцептом) данной Политики. Акцепт
              оферты означает безоговорочное согласие Пользователя с условиями
              обработки его персональных данных, изложенных в настоящей Политике
            </p>

            <p>
              1.6. В случае несогласия с этими условиями Пользователь должен
              воздержаться от использования сервисов веб - сайта.
            </p>
            ...
            <p>
              2.15. «Cookie» — небольшой фрагмент данных, отправленный
            ...
            <ul className="list-disc pl-6 space-y-2 mt-2">
              ...
              <li>
                вправе передавать персональные данные третьим лицам либо
                поручать обработку персональных данных третьим лицам, если это
                будет необходимо для достижения цели их обработки в соответствии
                с настоящей Политикой, а также в случаях, предусмотренных
            ...
            <ul className="list-disc pl-6 space-y-2 mt-2">
              <li>
                обрабатывать персональные данные только в указанных в разделе 7
                целях;
              </li>
              <li>
            ...
            <p className="mt-4">4.2. Пользователь обязан:</p>
            <ul className="list-disc pl-6 space-y-2 mt-2">
            ...
            <p>-информация о Вашей активности во время использования Сайта.</p>
            <p>-информация о геолокации;</p>
            <p>
              5.5. динамический IP адрес, информация от провайдера, на сайте
              происходит сбор и обработка данных о посетителях (в т.ч. файлов
              «cookie») с помощью сервисов интернет-статистики (Яндекс Метрика и
              других).
            </p>
            <p>
            ...
            <p>
              5.9. Согласие на обработку персональных данных, разрешенных для
              распространения, Пользователь предоставляет Оператору
              непосредственно.
            </p>
            <p>
              5.10. Оператор не проверяет достоверность персональных данных,
              предоставляемых Пользователем сайта. Оператор исходит из того, что
              предоставленная Персональная информация достоверная.
            </p>
            <p>
              5.11. Передача (распространение, предоставление, доступ)
            ...
            <p>
              5.12. Согласие на обработку персональных данных, разрешенных для
              распространения, прекращает свое действие с момента поступления
              Оператору требования, указанного в п. 9.6. настоящей Политики в
            ...
            <h3 className="text-white font-medium text-xl mt-8 mb-4">
              7. Цели обработки персональных данных Пользователя
            </h3>
            ...
            <ul className="list-disc pl-6 space-y-2 mt-2">
              ...
              <li>
                ...
                запросов и информации, касающихся использования сайта, а также
                обработка запросов и заявок от субъекта.
              </li>
              <li>формирование маркетинговой политики Оператора;</li>
              <li>
                заключение, исполнение и прекращение гражданско-правовых
                договоров;
              </li>
              <li>
                улучшение качества сайта и его содержания, удобства его
                использования, предоставление Пользователю эффективной
              ...
              <li>
                ...
                материалам, содержащимся на веб-сайте https://sibkomplekt.ru.
              </li>
            ...
            <p>
              ...
              https://sibkomplekt.ru/ или направленные Оператору посредством
            ...
            <p>
              8.3. Оператор обрабатывает данные о Пользователе в случае, если
            ...
            <p>
              9.2. Оператор обеспечивает сохранность персональных данных и
              принимает все возможные меры, исключающие доступ к персональным
              данным неуполномоченных лиц.
            </p>
            <p>
              9.3. Персональные данные Пользователя никогда, ни при каких
            ...
            <p>
              Для выполнения целей, указанных в разделе 7. Оператор может
              передавать конфиденциальную информацию, в процессе взаимодействия
              Сайта с другими сервисами (Битрикс, Mail.ru Group, Telegram Ads,
              сервисы Яндекс) используя Сайт Вы соглашаетесь на такую передачу,
              Обработка, хранение, передача информации осуществляется в
              соответствии с политиками конфиденциальности третьих лиц.
            </p>
            <p>
              ...
              Оператора info@sibkomplekt.ru с пометкой «Актуализация
              персональных данных».
            </p>
            <p>
            ...
            <p>
              9.6. Пользователь может в любой момент отозвать свое согласие на
              обработку персональных данных, направив Оператору уведомление
              посредством электронной почты на электронный адрес Оператора
              info@sibkomplekt.ru с пометкой «Отзыв согласия на обработку
              персональных данных».
            </p>
            <p>
              9.7. Вся информация, которая собирается сторонними сервисами, в
            ...
            <p>
              9.8. Установленные субъектом персональных данных запреты на
            ...
            <p>
              9.9. Оператор при обработке персональных данных обеспечивает
              конфиденциальность персональных данных.
            </p>
            <p>
              9.10. Оператор осуществляет хранение персональных данных в форме,
              позволяющей определить субъекта персональных данных, не дольше,
              чем этого требуют цели обработки персональных данных, если срок
              хранения персональных данных не установлен федеральным законом,
              договором, стороной которого, выгодоприобретателем или поручителем
            ...
            <p>
              9.11. Условием прекращения обработки персональных данных может
              ...
              неправомерной обработки персональных данных, ликвидация Оператора.
            </p>
            ...
            <p>
              10.3. Оператор имеет право направлять Пользователю уведомления о
              ...
              электронной почты info@sibkomplekt.ru с пометкой «Отказ от
            ...
            <p>
              11.1. Оператор и иные лица, получившие доступ к персональным
            ...
            <p>
              12.1. До обращения в суд с иском по спорам, возникающим из
              отношений между Пользователем веб - сайта и Оператором,
              обязательным является предъявление претензии (письменного
              предложения о добровольном урегулировании спора).
            </p>
            <p>
              12.2 Получатель претензии в течение 30 календарных дней со дня
              получения претензии, письменно уведомляет заявителя претензии о
              результатах рассмотрения претензии.
            </p>
            <p>
              12.3. При не достижении соглашения спор будет передан на
            ...
            <p>
              ...
              бессрочно до замены ее новой версией. Оператор вправе вносить
            ...
            <p>
              ...
              сети Интернет по адресу https://sibkomplekt.ru/privacy.
            </p>
          </div>
        </CustomContainer>
      </section>
